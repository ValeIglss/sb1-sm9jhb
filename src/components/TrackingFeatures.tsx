...
export default function TrackingFeatures() {
  ...
  const titles = {
    en: {
      mainTitle: "Premium Tracking System",
      subtitle: "Experience unparalleled visibility of your trophy's journey with our sophisticated tracking system",
      comingSoon: "Exclusive Mobile App Coming Soon"
    },
    es: {
      mainTitle: "Sistema de Seguimiento Premium",
      subtitle: "Disfrute de una visibilidad inigualable del recorrido de su trofeo con nuestro sofisticado sistema de seguimiento",
      comingSoon: "App Móvil Exclusiva Próximamente"
    }
  };
